...
1. Modul 1: BST Tabel Variabel (Lucky)
...
O(logn)
2. Modul 2: CLI Kalkulator (Lucky)
...
3. Modul 3: Evaluasi_Postfix (Fahreza)
...
O(n)
4. Modul 4: Expression_Tree (Binary Tree) (Fauzan)
...
5. Modul 5: Graph_Dependensi_Formula (DAG) (Adhi)
...
6. Modul 6: Konversi_Infix_Ke_Postfix (Adhi)
